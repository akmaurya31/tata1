...
<!-- Mirrored from zudiofranchisee.org/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2024 18:10:57 GMT -->
...
<body>
    ...
    <div id="main-wrapper">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="text-left py-5 mt-3 mb-3">
                            <h1 class="ft-medium text-white mb-3">About Us</h1>
                            <ol class="breadcrumb">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="abt_caption">
                            <h2 class="ft-medium mb-4">About Zudio Franchise</h2>
                            <p class="mb-4">
                                In Bangalore, the first Zudio location, approximately 8000
                                square feet, opened for business in September 2016. There are
                                currently 352 outlets throughout India. Products from the
                                Zudio franchise are available in the following categories:
                                loungewear, footwear, kids’ clothing, men’s clothing, women’s
                                clothing, and beauty items.
                            </p>
                            <p class="mb-4">
                                FOCO, short for Franchise Owned, Company Operated, is a
                                particular kind of franchise agreement in which the franchisor
                                keeps ownership of the business while letting a franchisee
                                handle day-to-day operations. While the corporation supports
                                and manages the franchisee’s business on their behalf, the
                                franchisee invests it.
                            </p>
        ...
        <!-- ======================= About Us End ======================== -->
        <!-- ======================= Deals of The Day ====================== -->
        <section class="bg-cover" style="background:url(assets/img/banner-c.jpg) no-repeat;" data-overlay="5">
            <div class="container">
...
<!-- Mirrored from zudiofranchisee.org/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2024 18:11:00 GMT -->
</html>